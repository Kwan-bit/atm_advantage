...
namespace ATM.ConsoleApplication
{
    public class AtmApp : IATMApp, ITransaction, IUserBankAccount
    {
        ...
        private const decimal minimum_kept_amt = 50000;
        ...
        public void Initialization()
        {
            ...
            {
                new UserBankAccount() { Id=1, FullName = "Tran Le Trung Quan", AccountNumber=111222, CardNumber = 123123, CardPin = 111111, AccountBalance = 2000000, IsLocked = false },
                new UserBankAccount() { Id=2, FullName = "Dao Tan Hai", AccountNumber=333444, CardNumber = 456456, CardPin = 222222, AccountBalance = 1000000000, IsLocked = true },
                new UserBankAccount() { Id=3, FullName = "Tran Anh Phuong", AccountNumber=555666, CardNumber = 789789, CardPin = 333333, AccountBalance = 5000000, IsLocked = false }
                new UserBankAccount() { Id=3, FullName = "Pham Tran Ba Hoang", AccountNumber=777888, CardNumber = 321321, CardPin = 444444, AccountBalance = 5000000000, IsLocked = false }
                new UserBankAccount() { Id=3, FullName = "Nguyen Van A", AccountNumber=999000, CardNumber = 654654, CardPin = 555555, AccountBalance = 50000, IsLocked = true }
            };
